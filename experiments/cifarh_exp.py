...
def main():
    def load_model_trained_cifar(n):
    ...
    data_dir = '../data'
    path_model = '../exp_data/models/cifarh_wrn28_4_200epochs.pt'
    ...
    for trial in range(max_trials):
        ...
        model = load_model_trained_cifar(11)
        ...
        model_class = load_model_trained_cifar(10)
        model_expert = load_model_trained_cifar(2)
        ...
        model = load_model_trained_cifar(10)
        ...
        model_class = load_model_trained_cifar(10)
        model_rejector = load_model_trained_cifar(2)
        ...
        with open("../exp_data/data/cifarh_exp_" + date_now + ".pkl", "wb") as f:
